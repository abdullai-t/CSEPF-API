...
from .views.presentations import (
    add_presentation,
    delete_presentation,
    presentations_list,
    update_presentation,
...
from .views.site_trips import (
    add_image_to_site_trip,
    create_site_trip,
    delete_site_trip,
    remove_image_from_site_trip,
    site_trip_images,
    site_trips_list,
    update_site_trip,
)
...
urlpatterns = [
    ...
    path(
        "presentations/update/<str:id>", update_presentation, name="update_presentation"
    ),
    path(
        "presentations/delete/<str:id>", delete_presentation, name="delete_presentation"
    ),
    #     site trips
    ...
    path(
        "site_trips/remove_image/<str:image_id>",
        remove_image_from_site_trip,
        name="remove_image_from_site_trip",
    ),
